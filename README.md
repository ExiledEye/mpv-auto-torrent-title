...
* Generally using stremio is faster than the torrent-metadata public endpoint which is faster than using the local server unless it's not already running.
